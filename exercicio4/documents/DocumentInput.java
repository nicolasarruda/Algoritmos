...
public class DocumentInput {
	...
	public void getArchiveLst(File fileLst, Document doc, File fileXML) throws TransformerException {
		TransformerFactory transFactory = TransformerFactory.newInstance();
		Transformer transformerXML = transFactory.newTransformer();
		transformerXML.transform(new DOMSource(doc), new StreamResult(fileLst));
	}
	...
	public void editContent(NodeList nodes, int editNumber, String line) {
